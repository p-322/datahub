...
export default function HeritageObjectCard({heritageObject}: Props) {
  ...
  return (
    <Link
      ...
      className="min-h-[200px] bg-neutral-100 border border-neutral-200 rounded-sm flex flex-col sm:flex-row gap-2 cursor-pointer hover:border-ink-800 no-underline"
