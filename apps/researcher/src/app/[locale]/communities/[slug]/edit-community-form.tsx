...
import {useSlideOut, useNotifications} from '@p-322/ui';
import {z} from 'zod';
    ...
    >
      ...
      <div className="flex flex-row max-w-2xl w-full">
        <div className=" flex flex-col md:flex-row justify-between  gap-2">
          <button
            className="p-1 sm:py-2 sm:px-3 rounded-full text-xs bg-accent-300 hover:bg-neutral-300 text-neutral-800 transition flex items-center gap-1"
