...
async function AddProvenanceButton() {
  ...
  return (
    <SlideOutButton
      className="mb-4 py-2 px-3 p-1 sm:py-2 sm:px-3 rounded-full text-xs bg-accent-300 text-ink-800 transition flex items-center gap-1 hover:bg-accent-200 whitespace-pre"
      id={slideOutId}
    >
