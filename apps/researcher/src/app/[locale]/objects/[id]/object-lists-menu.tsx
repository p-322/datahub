...
function CommunityMenuItems({
  ...
  if (isPending) {
    return (
      <div className="pr-4 pl-10 py-2 text-sm text-ink-600 italic">
        {t('loadingLists')}
      </div>
    );
  }
    ...
    <>
        ...
        <div>
          {objectLists.map(objectList => (
            <button
              ...
              className="group flex items-center px-4 py-2 text-sm ink-800"
            >
              <span className="mr-2 h-4 w-4 text-ink-500 group-hover:text-ink-700">
      ...
      {canAddList && (
        <button
          ...
          className="group flex items-center pr-4 pl-10 py-2 text-sm ink-800"
        >
